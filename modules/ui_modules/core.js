...
export function togglePanel(forceShow = null) {
    ...
    if (shouldShow) {
        ...
        // Check if we need to show character selection first
        if (PhoneSim_State.characters.length === 0 || !PhoneSim_State.currentCharacterId) {
            // No characters exist or no character selected, show character selection
            PhoneSim_State.isCharacterSelectionVisible = true;
            PhoneSim_State.currentView = 'CharacterSelection';
...
export function rerenderCurrentView(updates = {}) {
    ...
    switch(currentViewId) {
        case 'CharacterSelection':
            // Character selection doesn't need an active ID
            break;
...
export function renderViewContent(viewId, ...args) {
    ...
    switch(viewId) {
        case 'CharacterSelection': UI.renderCharacterSelection(); break;
